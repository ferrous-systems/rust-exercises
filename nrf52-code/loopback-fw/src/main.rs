...
mod app {
    ...
    const ACM_QUEUE_LEN: usize = SERIAL_BUFFER_SIZE;
    ...
    struct WriteAsyncPipeAdapter {
        ...
        buffer: heapless::String<SERIAL_BUFFER_SIZE>,
    ...
    fn init(mut ctx: init::Context) -> (MySharedResources, MyLocalResources) {
        ...
        // Using the default value of 100 mA was problematic for the Ubuntu boot process USB
        // enumeration.
