...
mod app {
    ...
    struct MySharedResources {
        ...
        usb_hid: usbd_hid::hid_class::HIDClass<'static, dk::UsbDevice>,
    ...
    fn init(ctx: init::Context) -> (MySharedResources, MyLocalResources) {
        ...
        board.radio.set_channel(dk::ieee802154::Channel::_20);
        ...
        let local = MyLocalResources {
            radio: board.radio,
            current_channel,
            packet: dk::ieee802154::Packet::new(),
            timer: board.timer,
            rx_count: 0,
            err_count: 0,
            msg_queue_out,
    ...
    fn idle(mut ctx: idle::Context) -> ! {
        ...
        loop {
            while let Some(msg) = ctx.local.msg_queue_out.dequeue() {
                match msg {
                    ...
                    Message::ChangeChannel(n) => {
                        ...
                        match n {
                            11 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_11);
                            }
                            12 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_12);
                            }
                            13 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_13);
                            }
                            14 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_14);
                            }
                            15 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_15);
                            }
                            16 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_16);
                            }
                            17 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_17);
                            }
                            18 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_18);
                            }
                            19 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_19);
                            }
                            20 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_20);
                            }
                            21 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_21);
                            }
                            22 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_22);
                            }
                            23 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_23);
                            }
                            24 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_24);
                            }
                            25 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_25);
                            }
                            26 => {
                                ctx.local.radio.set_channel(dk::ieee802154::Channel::_26);
                            }
                            _ => {
            ...
            match ctx.local.radio.recv_timeout(
                ...
                Err(dk::ieee802154::Error::Crc(_)) => {
                    defmt::debug!("RX fail!");
                    let _ = write!(writer, "!");
                    *ctx.local.err_count += 1;
                }
                Err(dk::ieee802154::Error::Timeout) => {
