...
- [Fizzbuzz](./fundamentals/fizzbuzz.md)
  - [Fizzbuzz Cheat-Sheet](./fundamentals/fizzbuzz-cheat-sheet.md)
- [Fizzbuzz with match](./fundamentals/fizzbuzz-match.md)
- [Rust Latin](./fundamentals/rustlatin.md)
- [URLs, match, result](./fundamentals/urls-match-result.md)
- [Calculator](./fundamentals/calculator.md)
- [Iterators](./fundamentals/iterators.md)
- [SimpleDB](./fundamentals/simple-db.md)
  - [Knowledge](./fundamentals/simple-db-knowledge.md)
  - [Step-by-Step Solution](./fundamentals/simple-db-solution.md)
- [Green and Yellow game](./fundamentals/green-yellow-game.md)

# Applied Rust

- [Shapes](./applied/shapes.md)
- [TCP Echo Server](./applied/tcp-server.md)
  - [Share data between connections](./applied/tcp-server-log.md)
- [Connected Mailbox](./applied/connected-mailbox.md)
- [Multithreaded mailbox](./applied/multi-threaded-mailbox.md)
...
- [Verifying Data Structures with Kani](./advanced/kani-linked-list.md)
- [Building a Linux Kernel Driver using Rust](./advanced/building-linux-kernel-driver.md)
...
- [STM32 Green and Yellow Exercise](./stm32/green-yellow.md)
  - [Parts of an Embedded Program](./stm32/green-yellow-parts-embedded-program.md)
  - [Building an Embedded Program](./stm32/green-yellow-building-program.md)
...
- [STM32 UART Interrupt Exercise](./stm32/uart.md)
  - [RTIC hello](./stm32/uart-rtic-hello.md)
  - [Event Handling](./stm32/uart-event-handling.md)
  - [Task State](./stm32/uart-task-state.md)
  - [Async Tasks](./stm32/uart-async-tasks.md)
  - [Handle UART Received Data](./stm32/uart-handle-received-data.md)
...
- [Working without std](./real-time/realtime-withoutstd.md)
  - [Replacing println!](./real-time/realtime-withoutstd-println.md)
- [Bare-Metal Firmware on Cortex-R52](./real-time/realtime-v8r-preparation.md)
  - [UART Driver](./real-time/realtime-v8r-uart.md)
