...
- [nRF52 USB Workbook](./nrf52-usb-workbook.md)
  ...
  - [SET_ADDRESS](./nrf52-usb-set-address.md)
    ...
    - [SET_CONFIGURATION (Linux & Mac OS)](./nrf52-usb-set-config.md)
...
- [Troubleshooting](./nrf52-troubleshooting.md)
  ...
  - [`cargo-flash` is not working](./nrf52-troubleshoot-cargo-flash.md)
  ...
  - [`dongle-flash` is not working](./nrf52-troubleshoot-dongle-flash.md)
