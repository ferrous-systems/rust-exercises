...
Install `probe-rs` 0.30.0 pre-compiled binaries on Linux with:
...
Install `probe-rs` 0.30.0 pre-compiled binaries on Windows with:
...
Install `probe-rs` 0.30.0 pre-compiled binaries on macOS with:
