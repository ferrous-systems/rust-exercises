...
The default in a Cargo project is to compile for the host (native compilation). The [`nrf52-code/radio-app`](../../../nrf52-code/radio-app) project has been configured for cross compilation to the ARM Cortex-M4 processor. This configuration can be seen in the Cargo configuration file (`.cargo/config`):
